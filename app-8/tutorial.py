...
class Launcher: 
 ...
 def launch(self): 
  color = random.choice(COLORS)
  explode_height = random.randrange(50, 600)
...
def main(): 
 ...
 launchers = [Launcher(100, HEIGHT-Launcher.HEIGHT, 3000), Launcher(300, HEIGHT-Launcher.HEIGHT, 4000), Launcher(500, HEIGHT-Launcher.HEIGHT, 2000), Launcher(700, HEIGHT-Launcher.HEIGHT, 5000)]
